...
class BookingSerializer(serializers.ModelSerializer):
    # Nested read-only tour details so the frontend doesn't need a second
    # request
    tour_title = serializers.CharField(source='tour.title', read_only=True)
    tour_location = serializers.CharField(
        source='tour.location', read_only=True)
    ...
    tour_category = serializers.CharField(
        source='tour.category', read_only=True)
